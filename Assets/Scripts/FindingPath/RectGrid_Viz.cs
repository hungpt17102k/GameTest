...
public class RectGrid_Viz : MonoBehaviour
{
  ...
  public void Init()
  {
    ...
    // Set pivot
    this.transform.localPosition = pivotTrans.localPosition;
  }
  ...
  public void ToggleWalkable(RectGridCell_Viz sc)
  {
    ...
    else
    {
      ...
      // Add to config
      ConfigManager.Instance.AddToMapConfig(x, y);
    }
  }
  ...
  void RayCastAndSetDestination()
  {
    ...
    if (hit)
    {
      ...
      mDestination.localPosition = pos;
  ...
  public Transform GetCellTrans(int x, int y)
  {
    if(x >= 0 && x < mX && y >=0 && y < mY)
    {
      return mRectGridCellGameObjects[x, y].transform;
    }
    return null;
  }
